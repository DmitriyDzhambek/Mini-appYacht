...
- 🎯 **Реклама**: Rewarded interstitial ads для монетизации
- ⚡ **Serverless**: Развернуто на Vercel с serverless функциями

## 🛠 Технологии

- **Frontend**: HTML5, CSS3, JavaScript (ES6+)
- **Backend**: Node.js, Express.js (Serverless на Vercel)
- **Telegram**: Telegram WebApp API
- **Хранение**: localStorage + API бэкенда
- **Геолокация**: Geolocation API
- **Деплой**: Vercel (serverless функции)
- **Монетизация**: Telegram Rewarded Ads
